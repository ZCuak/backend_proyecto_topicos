<turbo-frame id="modal-frame">
    <div id="flyonui-modal-container">
        ...
        <div id="editModal"
            ...
            <div class="flyonui-dialog relative bg-white rounded-2xl shadow-2xl w-full max-w-6xl overflow-hidden 
                ...
                <div class="flyonui-body p-6 bg-white overflow-y-auto max-h-[85vh]">
                    <form action="{{ route('zones.update', $zone->id) }}"
                          method="POST"
                        ...
                        @include('zones._form', ['buttonText' => 'Actualizar'])
                    </form>
                </div>
            </div>
        </div>
