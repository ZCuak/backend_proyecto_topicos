<turbo-frame id="modal-frame">
    <div id="flyonui-modal-container">
        ...
        {{-- Modal --}}
        <div id="createModal" class="flyonui-modal fixed inset-0 flex items-center justify-center z-[9999]" data-flyonui
            role="dialog" aria-modal="true">

            <div
                class="flyonui-dialog relative bg-white rounded-2xl shadow-2xl w-full 
                ...
                <div
                    ...
                    <button type="button" onclick="FlyonUI.modal.close('createModal')"
                ...
                {{-- Body --}}
                <div class="flyonui-body p-6 bg-white max-h-[85vh] overflow-y-auto">
                    <form action="{{ route('attendances.store') }}" method="POST" enctype="multipart/form-data"
                        data-turbo-frame="modal-frame" class="space-y-6">
                        @csrf
